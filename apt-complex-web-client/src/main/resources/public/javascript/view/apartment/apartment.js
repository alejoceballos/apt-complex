(function() {
    var app = angular.module('app-view-apartment',
        [
            'app-domain',
            'ui.bootstrap',
    ...
    app.service('remoteApiService', [
        ...
        function($http, growl) {
            ...
            this.getApartmentBalanceGroup = function(year, month) {
                var options = {
                    method: 'GET',
                    url: url + "apartment/year/" + year + "/month/" + month
                };

                growl.info("Retrieving apartments balances");

                return $http(options).then(
                    function(response) {
                        growl.success("Apartments balances retrieved");
                        return response.data;
                    }
                ).catch(
                    function(err) {
                        growl.error("Error retrieving apartments balances (" + err.status + " - " + err.statusText + ")");
                        console.log(err);
                        throw err;
                    }
                );
    ...
    */
    ...
    app.controller('ApartmentController',
        [
            ...
            'remoteApiService',
            'domainService',
            function($scope, remoteApiService, domainService) {
